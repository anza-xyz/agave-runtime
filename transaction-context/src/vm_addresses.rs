...
pub const GUEST_SYSVARS_BASE_ADDRESS: u64 =
    nonoverlapping_base_address(264, GUEST_ACCOUNT_PAYLOAD_END_ADDRESS);
pub const GUEST_SYSVARS_END_ADDRESS: u64 = GUEST_SYSVARS_BASE_ADDRESS + from_index(7);

pub const GUEST_INSTRUCTION_DATA_BASE_ADDRESS: u64 =
    nonoverlapping_base_address(271, GUEST_ACCOUNT_PAYLOAD_END_ADDRESS);
...
pub const GUEST_INSTRUCTION_ACCOUNT_BASE_ADDRESS: u64 =
    nonoverlapping_base_address(335, GUEST_INSTRUCTION_DATA_END_ADDRESS);
